    ...
    if($i === 0){ // front end icon
        echo ("<div class='right animation-slide-in-left delay'>");
            ...
            echo ("<div class='icon front-end-icon'>");
                ...
                echo ("<img class='cursor animation-cursor-move' src=". $src ." alt='' draggable='false' />");
                echo ("<img class='cursor animation-cursor-move cursor-shadow' src=". $src ." alt='' draggable='false' />");
